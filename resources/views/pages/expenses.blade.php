            ...
            <div class="panel panel-primary">
                ...
                <div id="extractContent" class="collapse in">
                    <div class="panel-body" style="">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-5" style="border-color:#999999;border-style:dotted">
                                    <img class="center-block" style=" width: 500px;
                                    height: 700px;
                                    background-position: center;
                                    background-size: cover;" id="" src='assets/images/1.jpg'/>
                                </div>
                                <div class="col-md-6">
                                    <div id="extracted">
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                ...
                                                <input type="text" class="form-control" value="Jollibee Fast food" id="dataExtract" disabled="disable"> 
